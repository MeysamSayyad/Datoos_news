      ...
      <div className=" w-full grid grid-cols-1 lg:grid-cols-4 items-start gap-5">
        ...
        {toggleForm ? (
          ...
          <span
            ...
            className=" self-center justify-self-center flex items-center rounded-full px-3 h-12 gap-1 justify-center text-white transition-all py-2 bg-opacity-70 group w-12 overflow-clip  hover:bg-opacity-75 cursor-pointer hover:w-28 bg-primary"
          >
